...
echo "<td>".$row['PriorityLevel']."<br/><a href='ChangePriorityLevelHigh.php?id=$id' style='text-decoration: none;'>High"."<br/><a href='ChangePriorityLevelLow.php?id=$id' style='text-decoration: none;'>Low"."</td>";
